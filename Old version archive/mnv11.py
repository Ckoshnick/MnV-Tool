...
#==============================================================================
    ...
    def _outlier_plot(self, temp, yrange=None):
...
class ols_model():
    ...
    def __init__(self, pre, post, params, rate = 1, randomState=None):
        
#        self.params = self.ModelParameters(**inputDict)
        ...
        self.split_test_train(how='random')
...
class many_ols():
    ...
    def _pool_stats(self):
        ...
        # Re-order columns
        self.statsPool = self.statsPool[['AIC','AR2','R2','MSE','postDiff',
                                         'params','summary']]
